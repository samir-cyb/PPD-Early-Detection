...
run from -- run it from this same "paper" folder, alongside
chapter1_introduction.tex / your main.tex, so the relative path in
\\includegraphics resolves correctly when you compile).
